...
const Kortai = () => {
    ...
    const validateInput = (data) => {
        ...
        if (!numberOnlyRegex.test(data.lstoony_ojd)) {
            errors.lstoony_ojd = "لستوڼی اوږدوالی صحي کړئ.";
        }
        if (!numberOnlyRegex.test(data.lstoony_browali)) {
            errors.lstoony_browali = "لستوڼی بروالی صحي کړئ.";
        }
