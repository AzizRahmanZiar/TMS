...
const Navbar = () => {
    ...
    return (
        <motion.nav
            className="bg-primary-900 shadow-lg sticky top-0 z-[9999]  backdrop-blur-sm"
                            ...
                            <div className="px-4 py-4 space-y-2">
                                ...
                                {user ? (
                                    <>
                                        ...
                                        {/* Profile Link for Mobile - Only for admin, tailor, and shopkeeper */}
                                        {(user.role === "admin" ||
                                            user.role === "tailor" ||
                                            user.role === "shopkeeper") && (
                                            <motion.div
                                            ...
                                            >
                                                <Link
                                                    ...
                                                    className="block w-full text-center font-bold font-zar text-xl px-4 py-2 rounded-md transition bg-primary-600 text-primary-50 hover:bg-primary-700"
                                                >
                                                    پروفایل
                                                </Link>
                                            </motion.div>
