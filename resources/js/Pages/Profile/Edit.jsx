...
export default function Edit({ auth, mustVerifyEmail, status }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={
                <h2 className="font-semibold text-xl text-gray-800 leading-tight font-zar">
                    د پروفایل تنظیمات
                </h2>
            }
        >
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold font-zar">د پروفایل تنظیمات</h1>
                                <p className="text-white/80 font-zar">خپل د حساب معلومات او تنظیمات اداره کړئ</p>
                            </div>
                        </div>
                    </motion.div>
