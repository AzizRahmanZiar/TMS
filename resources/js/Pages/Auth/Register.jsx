            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        name="profile_image"
                                        onChange={handleChange}
                                        className={`w-full p-2 border rounded-lg focus:ring-2 focus:ring-primary-100 focus:border-primary-500 transition-all file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-primary-50 file:text-primary-700 hover:file:bg-primary-100 ${
                                            errors.profile_image
                                                ? "border-red-500 bg-red-50"
                                                : "border-gray-200"
                                        }`}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        value={formData.experience}
                                        onChange={handleChange}
                                        className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-accent-100 focus:border-accent-500 transition-all shadow-input ${
                                            errors.experience
                                                ? "border-red-500 bg-red-50"
                                                : "border-gray-200"
                                        }`}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        value={formData.tailoring_name}
                                        onChange={handleChange}
                                        className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-secondary-100 focus:border-secondary-500 transition-all shadow-input ${
                                            errors.tailoring_name
                                                ? "border-red-500 bg-red-50"
                                                : "border-gray-200"
                                        }`}
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                        <label className="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-secondary-50 transition-colors">
                                            <input
                                                type="checkbox"
                                                name="payment_methods"
                                                value="Cash"
                                                ...
                                                onChange={handleChange}
                                                className="rounded text-secondary-500 focus:ring-2 focus:ring-secondary-300 ml-2"
                                            />
                                            <span className="text-gray-700">
                                                نقد
                                            </span>
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            name="shop_images"
                                            onChange={handleChange}
                                            className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-secondary-100 focus:border-secondary-500 transition-all file:ml-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-secondary-50 file:text-secondary-700 hover:file:bg-secondary-100 ${
                                                errors.shop_images
                                                    ? "border-red-500 bg-red-50"
                                                    : "border-gray-200"
                                            }`}
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        value={formData.social_links.facebook}
                                        onChange={handleChange}
                                        className="w-full p-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-secondary-100 focus:border-secondary-500 transition-all shadow-input"
                                        placeholder="د فیسبوک پاڼه URL"
                                    />
                                    {errors["social_links.facebook"] && (
                                        <p className="text-red-500 text-sm mt-1">
                    ...
                    <div className="flex justify-start">
                        <button
                            type="submit"
                            className="flex items-center bg-gradient-to-r from-primary-500 to-secondary-600 hover:from-primary-600 hover:to-secondary-700 text-white font-medium py-3 px-10 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50"
                        >
