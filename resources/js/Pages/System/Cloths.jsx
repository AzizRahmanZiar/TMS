    ...
    return (
        <SystemLayout>
            <div className="p-6">
                ...
                {isModalOpen && (
                    <motion.div
                        className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center z-0 p-4"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        {[
                                            ...
                                            { name: "kalari", label: "کلاري" },
                                            {
                                                name: "shabazi",
                                                label: "شبازي",
                                            },
                                            { name: "arabi", label: "عربي" },
                                            { name: "lemen", label: "لیمن" },
                                            {
                                                name: "lastoni_2",
                                                label: "لستونی ۲",
                                            },
